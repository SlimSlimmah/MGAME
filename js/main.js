...
import { processOfflineActivity, completeActivity } from './skills.js';
...
import { showCharacterList, showCharacterCreation, switchGameTab, switchSkillsTab, toggleSkillSection, openEquipmentSelector, closeEquipmentModal, updateEquipmentUI, updateInventoryUI, updatePlayerStats, renderCharacterSlots } from './ui.js';
import { startGathering, startProcessing, stopGathering, saveCharacterActivity } from './skills.js';
...
window.saveCharacterActivity = saveCharacterActivity;
...
window.renderCharacterSlots = renderCharacterSlots;
